...
import { createRouter, createRootRouteWithContext, createFileRoute, lazyRouteComponent, HeadContent, Scripts, ClientOnly, Outlet } from "@tanstack/react-router";
...
const appCss = "/assets/styles-Bud6W0Pv.css";
...
function LenisScroll() {
  useEffect(() => {
    ...
    const lenis = new Lenis({
      ...
      // Optional, usually wrapper is enough but can be explicit
      duration: 1.2,
      // Smoothness duration
...
const Route$5 = createRootRouteWithContext()({
  ...
  notFoundComponent: () => /* @__PURE__ */ jsx("div", { children: "404" }),
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs(
      "body",
      {
        className: "geist-font bg-[#f2f2f2] h-screen",
...
const $$splitComponentImporter$4 = () => import("./route-DClB7kTC.mjs");
const Route$4 = createFileRoute("/(main)")({
...
const $$splitComponentImporter$3 = () => import("./index-C2gv6l1o.mjs");
...
const $$splitComponentImporter$2 = () => import("./_slug-BIrjXgkV.mjs");
...
const Route$2 = createFileRoute("/blogs/$slug")({
...
const $$splitComponentImporter$1 = () => import("./products-DCUY6-p6.mjs");
const Route$1 = createFileRoute("/(main)/products")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./about-Df0eEa4s.mjs");
const Route = createFileRoute("/(main)/about")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const mainRouteRoute = Route$4.update({
  id: "/(main)",
  getParentRoute: () => Route$5
});
const mainIndexRoute = Route$3.update({
  id: "/",
  path: "/",
  getParentRoute: () => mainRouteRoute
});
const BlogsSlugRoute = Route$2.update({
  id: "/blogs/$slug",
  path: "/blogs/$slug",
  getParentRoute: () => Route$5
});
const mainProductsRoute = Route$1.update({
  id: "/products",
  path: "/products",
  getParentRoute: () => mainRouteRoute
});
const mainAboutRoute = Route.update({
  id: "/about",
  path: "/about",
  getParentRoute: () => mainRouteRoute
});
const mainRouteRouteChildren = {
  mainAboutRoute,
  mainProductsRoute,
  mainIndexRoute
};
