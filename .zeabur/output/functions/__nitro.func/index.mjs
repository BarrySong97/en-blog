...
const _lazy_8mLGBw = defineLazyEventHandler(() => import("./chunks/_/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_8mLGBw };
  return ((_m, p) => {
...
const zeabur = toNodeHandler(useNitroApp().fetch);
export {
  HTTPError as H,
  zeabur as default,
  toRequest as t
